...
const FLAME_TONGUES = [
  { left: 30.4, top: 23.3, width: 16, rot: -5.3, delay: 0.01 },
  { left: 56.3, top: -6.9, width: 28, rot: -14.3, delay: 0.02 },
  { left: 7.1, bottom: 16.0, width: 24, rot: -22.0, delay: 0.1 },
  { left: 56.3, bottom: -6.2, width: 12, rot: 3.9, delay: 0.07 },
  { left: 83.8, top: 30.8, width: 20, rot: -4.0, delay: 0.1 },
  { left: 79.6, bottom: 6.2, width: 16, rot: -19.8, delay: 0.1 },
  { left: 52.8, top: 20.6, width: 14, rot: 3.2, delay: 0.11 },
  { left: 40.8, top: 3.5, width: 22, rot: -1.7, delay: 0.17 },
  { left: 77.4, top: 13.6, width: 19, rot: 14.0, delay: 0.01 },
  { left: 85.5, bottom: -3.5, width: 19, rot: -2.6, delay: 0.11 },
  { left: 39.8, bottom: 28.6, width: 22, rot: -17.4, delay: 0.09 },
  { left: 5.8, top: 5.3, width: 28, rot: 3.7, delay: 0.16 },
  { left: 33.0, bottom: 27.9, width: 26, rot: 4.0, delay: 0.08 },
  { left: 45.4, top: 19.1, width: 17, rot: -21.8, delay: 0.13 },
  { left: 97.3, top: -9.0, width: 26, rot: -10.8, delay: 0.07 },
  { left: 44.2, bottom: 21.2, width: 16, rot: 5.5, delay: 0.09 },
  { left: 10.9, top: -6.4, width: 18, rot: -5.1, delay: 0.17 },
  { left: 42.9, top: 28.9, width: 28, rot: -11.1, delay: 0.02 },
  { left: 25.8, top: 33.1, width: 24, rot: 24.3, delay: 0.12 },
  { left: 13.1, bottom: 10.4, width: 16, rot: -17.4, delay: 0.12 },
  { left: 56.9, top: 32.9, width: 20, rot: -10.9, delay: 0.03 },
  { left: 54.6, top: 42.9, width: 16, rot: 9.5, delay: 0.09 },
  { left: 72.0, top: 33.7, width: 26, rot: 20.0, delay: 0.14 },
  { left: 37.9, bottom: -5.4, width: 14, rot: -0.9, delay: 0.07 },
  { left: 18.9, bottom: -8.0, width: 16, rot: -19.5, delay: 0.11 },
  { left: 13.1, bottom: 25.2, width: 14, rot: 22.4, delay: 0.11 },
  { left: 59.4, top: 32.7, width: 16, rot: 6.7, delay: 0.17 },
  { left: 10.3, top: 4.0, width: 26, rot: 24.7, delay: 0.08 },
  { left: 12.4, bottom: 11.6, width: 19, rot: -7.9, delay: 0.05 },
  { left: 18.5, bottom: 20.8, width: 28, rot: -6.9, delay: 0.12 },
  { left: 27.8, top: 13.3, width: 17, rot: 18.2, delay: 0.13 },
  { left: 88.8, top: 31.5, width: 22, rot: 13.6, delay: 0.1 },
  { left: 20.3, bottom: -0.4, width: 18, rot: 15.3, delay: 0.15 },
  { left: 47.3, top: 11.3, width: 19, rot: -23.6, delay: 0.01 },
  { left: 17.4, top: 33.0, width: 15, rot: 22.8, delay: 0.08 },
  { left: 34.5, top: -0.8, width: 18, rot: -19.9, delay: 0.08 },
]
